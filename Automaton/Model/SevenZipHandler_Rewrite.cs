...
{
    public class SevenZipHandler_Rewrite : IDisposable
    {
        ...
        public SevenZipHandler_Rewrite()
        {
        ...
        {
            var extractedPath = Path.Combine(TempDirectory, new FileInfo(path).Name);
        ...
        public void Copy(string source, string target)
        {
            ...
            string realTargetLocation = Path.Combine(InstallationLocation, target);
